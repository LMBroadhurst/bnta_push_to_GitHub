...
//    }
        ...
        Artwork checkNFT1 = new Artwork("a", "a", 1, "a");
        Artwork checkNFT2 = new Artwork("a", "a", 1, "a");
        Artwork checkNFT3 = new Artwork("a", "a", 1, "a");

        checkNFT1.addToArtUniverse(checkNFT1);
        checkNFT2.addToArtUniverse(checkNFT2);
        checkNFT3.addToArtUniverse(checkNFT3);

        System.out.println(checkNFT1.getNft_code());
        System.out.println(checkNFT2.getNft_code());
        System.out.println(checkNFT3.getNft_code());
    }
}
