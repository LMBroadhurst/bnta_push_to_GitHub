...
unitedKingdom[1].touristAttractions = ["Stonehenge", "Big Ben", "Bristol Docks"];
console.log(england);
...
otherCountryPopulation = unitedKingdom[2].population;
scottishPopulation = unitedKingdom[0].population;

if (otherCountryPopulation > scottishPopulation) {
    console.log("Scottish population is smaller");
} else {
    console.log("Scottish population is bigger")
}